...
COMMANDS: Sequence[CommandSpec] = (
    ...
    CommandSpec("python ppltest.py --nproc 1 --setup 6 --calibration ../data/calib-data/27db/calibration_MXFP8_fixed_sum.json --lite --output ../data/calib-data/27db/ppl_results_MXFP8_fix_time.json --limit-samples 100 --figure5-layer-cycles --gpus 6"),
    CommandSpec('python ppltest.py --nproc 1 --setup 6 --calibration ../data/calib-data/29db/calibration_MXFP8_fixed_sum.json --lite --output ../data/calib-data/29db/ppl_results_MXFP8_fix_time.json --limit-samples 100 --figure5-layer-cycles --gpus 6'),
    CommandSpec('python ppltest.py --nproc 1 --setup 6 --calibration ../data/calib-data/30db/calibration_MXFP8_fixed_sum.json --lite --output ../data/calib-data/30db/ppl_results_MXFP8_fix_time.json --limit-samples 100 --figure5-layer-cycles --gpus 6')
