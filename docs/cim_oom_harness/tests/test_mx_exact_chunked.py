...
Copy to onlinearith/tests/test_mx_exact_chunked.py. These tests intentionally
fail until Codex implements _MXFPLinearBase._forward_mx_exact_chunked and wires
it into forward() for use_msd_truncation=False.
"""
