...
Copy this file to onlinearith/tools/probe_mxfp_memory.py and run from the
onlinearith repo root with PYTHONPATH pointing at the sibling transformers/src.
It does not require the new chunked MX implementation, but it will report much
better information after that implementation exists.
"""
...
from experiment_config import SETUPS, apply_config, reconfigure_mlp_layers, reset_to_baseline
