...
COMMANDS: Sequence[CommandSpec] = (
    ...
    CommandSpec("python ppltest.py --nproc 1 --setup 14 --output /home/xzj/coding/data/uniform_budget/ppl_9B_time.json --lite --gpus 2 --limit-samples 100 --figure5-layer-cycles"),
    CommandSpec('python ppltest.py --nproc 1 --setup 15 --output /home/xzj/coding/data/uniform_budget/ppl_11B_time.json --lite --gpus 2 --limit-samples 100 --figure5-layer-cycles'),
    CommandSpec('python ppltest.py --nproc 1 --setup 16 --output /home/xzj/coding/data/uniform_budget/ppl_10B_time.json --lite --gpus 2 --limit-samples 100 --figure5-layer-cycles')
