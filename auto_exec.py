...
COMMANDS: Sequence[CommandSpec] = (
    ...
    CommandSpec("python ppltest.py --nproc 1 --setup 6 --calibration ../data/calib-data/25db/calibration_MXFP8_fixed_sum.json --lite --output ../data/calib-data/25db/ppl_results_MXFP8_fix_time.json --limit-samples 100 --figure5-layer-cycles --gpus 7"),
    CommandSpec('python ppltest.py --nproc 1 --setup 11 --output /home/xzj/coding/data/uniform_budget/ppl_8B_time.json --lite --gpus 7 --limit-samples 100 --figure5-layer-cycles'),
    CommandSpec('python ppltest.py --nproc 1 --setup 12 --output /home/xzj/coding/data/uniform_budget/ppl_6B_time.json --lite --gpus 7 --limit-samples 100 --figure5-layer-cycles'),
    CommandSpec("python ppltest.py --nproc 1 --setup 13 --output /home/xzj/coding/data/uniform_budget/ppl_7B_time.json --lite --gpus 7 --limit-samples 100 --figure5-layer-cycles")
